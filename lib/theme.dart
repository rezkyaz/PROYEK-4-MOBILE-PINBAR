...
Color warnatulisankecil = Color(0xff504F5E);
...
TextStyle tulisankecilTextStyle = GoogleFonts.poppins(
  color: warnatulisankecil,
);

TextStyle tulisanTextStyle = GoogleFonts.poppins(
  color: warnatulisan,
);
